...
#include "trajectory_logger/srv/detail/save_trajectory__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = trajectory_logger::srv::SaveTrajectory_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const trajectory_logger::srv::SaveTrajectory_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<trajectory_logger::srv::SaveTrajectory_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_trajectory_logger
const rosidl_message_type_support_t *
get_message_type_support_handle<trajectory_logger::srv::SaveTrajectory_Request>()
{
  return &trajectory_logger::srv::typesupport_fastrtps_cpp::_SaveTrajectory_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = trajectory_logger::srv::SaveTrajectory_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const trajectory_logger::srv::SaveTrajectory_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<trajectory_logger::srv::SaveTrajectory_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &trajectory_logger::srv::typesupport_fastrtps_cpp::_SaveTrajectory_Response__handle;
}
...
{
  return &trajectory_logger::srv::typesupport_fastrtps_cpp::_SaveTrajectory__handle;
}
